...
def run_evaluation_suite(
    ...
    accuracy_results = evaluate_accuracy(model_predictions, ground_truth)
    ...
    if demographic_groups:
        fairness_results = evaluate_fairness(model_predictions, ground_truth, demographic_groups)
